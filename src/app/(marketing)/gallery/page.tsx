                            ...
                            <div className="bg-white border border-black/10 rounded-2xl overflow-hidden group hover:border-[#FFD700]/20 hover:shadow-md transition-all duration-500">
                                ...
                                <div className="h-40 md:h-48 bg-gradient-to-br from-white to-[#EFE8D8] relative overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 opacity-10">
                                        ...
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-black/10 rounded-full" />
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 border border-black/10 rounded-full" />
                                    </div>
                                </div>

                                <div className="p-5 md:p-6">
                                    <h3 className="font-heading font-bold text-base md:text-lg text-[#1A1A1A] mb-2">{project.title}</h3>
                                    <p className="text-muted-foreground text-sm mb-3 md:mb-4">{project.description}</p>
