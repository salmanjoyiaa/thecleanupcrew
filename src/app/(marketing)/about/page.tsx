            ...
            <section className="container mx-auto px-4 mb-24">
                <RevealOnScroll>
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-[#FFD700] text-sm font-semibold uppercase tracking-widest mb-4">About Us</p>
            ...
            <section className="container mx-auto px-4 mb-32">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <RevealOnScroll delay={0.1}>
                        <div className="bg-[#111111] border border-white/5 rounded-2xl p-8 hover:border-[#FFD700]/30 transition-all duration-500">
                            <div className="w-12 h-12 rounded-xl bg-[#FFD700]/10 flex items-center justify-center mb-6">
                                <Users className="w-6 h-6 text-[#FFD700]" />
                            </div>
                            <h3 className="font-heading font-bold text-xl text-white mb-3">Expert Team</h3>
                    ...
                    <RevealOnScroll delay={0.2}>
                        <div className="bg-[#111111] border border-white/5 rounded-2xl p-8 hover:border-[#22C55E]/30 transition-all duration-500">
                            <div className="w-12 h-12 rounded-xl bg-[#22C55E]/10 flex items-center justify-center mb-6">
                                <Leaf className="w-6 h-6 text-[#22C55E]" />
                            </div>
                            <h3 className="font-heading font-bold text-xl text-white mb-3">Eco-Friendly</h3>
                    ...
                    <RevealOnScroll delay={0.3}>
                        <div className="bg-[#111111] border border-white/5 rounded-2xl p-8 hover:border-[#FFD700]/30 transition-all duration-500">
                            ...
                            <h3 className="font-heading font-bold text-xl text-white mb-3">Fully Insured</h3>
                    ...
                    <RevealOnScroll delay={0.4}>
                        <div className="bg-[#111111] border border-white/5 rounded-2xl p-8 hover:border-[#A855F7]/30 transition-all duration-500">
                            <div className="w-12 h-12 rounded-xl bg-[#A855F7]/10 flex items-center justify-center mb-6">
                                <CheckCircle2 className="w-6 h-6 text-[#A855F7]" />
                            </div>
                            <h3 className="font-heading font-bold text-xl text-white mb-3">Guaranteed</h3>
            ...
            <section className="container mx-auto px-4">
                <div className="bg-[#111111] border border-white/5 rounded-2xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <RevealOnScroll direction="right" className="p-8 md:p-16 flex flex-col justify-center">
                            <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-6">Our Story</h2>
                            ...
                            <div className="mt-10">
                                <p className="font-heading text-3xl font-bold text-white mb-2">The Clean Up Crew</p>
                                <p className="text-sm font-bold tracking-widest text-[#FFD700] uppercase">Canada&apos;s Finest</p>
                            </div>
                        </RevealOnScroll>
                        <RevealOnScroll delay={0.2} direction="left" className="relative min-h-[400px] lg:min-h-full">
