                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    <RevealOnScroll delay={0.1}>
                        <div className="bg-white border border-black/10 rounded-2xl p-6 md:p-8 hover:border-[#FFD700]/30 hover:shadow-md transition-all duration-500">
                            ...
                            <h3 className="font-heading font-bold text-lg md:text-xl text-[#1A1A1A] mb-2 md:mb-3">Expert Team</h3>
                            <p className="text-muted-foreground text-sm">Every crew member is rigorously trained, background-checked, and committed to excellence.</p>
                        </div>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll delay={0.2}>
                        <div className="bg-white border border-black/10 rounded-2xl p-6 md:p-8 hover:border-[#22C55E]/30 hover:shadow-md transition-all duration-500">
                            ...
                            <h3 className="font-heading font-bold text-lg md:text-xl text-[#1A1A1A] mb-2 md:mb-3">Eco-Friendly</h3>
                            <p className="text-muted-foreground text-sm">We use 100% pure deionized water systems that leave zero chemical residue on your property.</p>
                        </div>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll delay={0.3}>
                        <div className="bg-white border border-black/10 rounded-2xl p-6 md:p-8 hover:border-[#FFD700]/30 hover:shadow-md transition-all duration-500">
                            ...
                            <h3 className="font-heading font-bold text-lg md:text-xl text-[#1A1A1A] mb-2 md:mb-3">Fully Insured</h3>
                            <p className="text-muted-foreground text-sm">Comprehensive liability insurance and WSIB compliance for your complete peace of mind.</p>
                        </div>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll delay={0.4}>
                        <div className="bg-white border border-black/10 rounded-2xl p-6 md:p-8 hover:border-[#A855F7]/30 hover:shadow-md transition-all duration-500">
                            ...
                            <h3 className="font-heading font-bold text-lg md:text-xl text-[#1A1A1A] mb-2 md:mb-3">Guaranteed</h3>
                            <p className="text-muted-foreground text-sm">If you spot a streak or smudge within 48 hours of our service, we&apos;ll re-clean it for free.</p>
                        </div>
                    </RevealOnScroll>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <RevealOnScroll direction="right" className="p-6 py-10 md:p-16 flex flex-col justify-center">
                            ...
                            <div className="mt-8 md:mt-10">
                                <p className="font-heading text-2xl md:text-3xl font-bold text-[#1A1A1A] mb-2">The Clean Up Crew</p>
                        ...
                        <RevealOnScroll delay={0.2} direction="left" className="relative min-h-[280px] md:min-h-[400px] lg:min-h-full">
                            <div className="absolute inset-0 bg-gradient-to-r from-[#F8F6F0] to-transparent z-10 hidden lg:block"></div>
